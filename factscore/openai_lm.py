...
class OpenAIModel(LM):
    ...
    def _generate(self, prompt, max_sequence_length=4096, max_output_length=512, few_shot=False):
    ...
    def call_ChatGPT(self,message, max_len=4096,max_new_tokens=512):
    ...
    def call_GPT3(self,message,max_len=4096, max_tokens = 512, num_log_probs=0, echo=False, verbose=False):
        # call GPT-3 API until result is provided and then return it
