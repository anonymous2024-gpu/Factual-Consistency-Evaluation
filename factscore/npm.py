...
class NPM(LM):
    ...
    def truncate_sequences(self, sequences, max_length):
        """Truncate sequences to ensure they fit within the model's maximum length."""
    ...
    def tokenize(self, texts, skip_special_tokens=False, padding=True):
        ...
        if max_length > 512:
            all_input_ids = self.truncate_sequences(all_input_ids, 512)
            max_length = 512
